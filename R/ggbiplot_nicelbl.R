#  Modified 2021 Matthew E. Wolak
## adds "pretty" group labels to ggbiplot::ggbiplot() plot
## Problem before was that groups with similar vectors had labels overlap
## This aggregates labels and prints them one after (instead of on top) the other
#
